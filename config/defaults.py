...
_C.ALGORITHM.ABLATION.MOOD=CN()
_C.ALGORITHM.ABLATION.MOOD.DUAL_BRANCH=False 
_C.ALGORITHM.ABLATION.MOOD.MIXUP= False
_C.ALGORITHM.ABLATION.MOOD.OOD_DETECTION= False
_C.ALGORITHM.ABLATION.MOOD.PAP_LOSS= False 
...
_C.ALGORITHM.OOD_DETECTOR.TEMPERATURE=1.
_C.ALGORITHM.OOD_DETECTOR.THRESH_PERCENT=0.05
_C.ALGORITHM.OOD_DETECTOR.K=10
...
_C.ALGORITHM.MOOD.ID_TEMPERATURE=0.1
_C.ALGORITHM.MOOD.OOD_TEMPERATURE=0.007
_C.ALGORITHM.MOOD.PAP_LOSS_WEIGHT=1.
_C.ALGORITHM.MOOD.WARMUP_EPOCH=10
...
# OPENMIX
_C.ALGORITHM.OPENMIX = CN()
_C.ALGORITHM.OPENMIX.THETA1 = 0.95
_C.ALGORITHM.OPENMIX.THETA2 = 0.9
_C.ALGORITHM.OPENMIX.LAMBDA1 = 5
_C.ALGORITHM.OPENMIX.LAMBDA2 = 1000
_C.ALGORITHM.OPENMIX.MIXUP_ALPHA = 1
...
_C.DATASET.DL.NUM_LABELED_HEAD = 500
...
_C.DATASET.DU.ID=CN()
_C.DATASET.DU.ID.NUM_UNLABELED_HEAD = 4000
...
_C.DATASET.DU.OOD.INCLUDE_ALL=False # if True, OOD RATIO is invalid.
...
_C.DATASET.NUM_VALID=5000 # total number of valid set 
