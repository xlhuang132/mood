...
class ABCTrainer(BaseTrainer):   
    def __init__(self, cfg):        
        ...
        self.ir2=self.labeled_trainloader.dataset.num_per_cls_list[-1]/self.labeled_trainloader.dataset.num_per_cls_list 
        if self.cfg.RESUME !="":
    ...
    def train_abc_step(self):
        ...
        maskforbalance = torch.bernoulli(torch.sum(targets_x2 * torch.tensor(self.ir2).cuda(0), dim=1).detach())
